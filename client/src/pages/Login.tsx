        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8">
          ...
          {error && (
            <motion.div 
              ...
              className="bg-red-500/20 backdrop-blur-sm border-l-4 border-red-500 p-4 mb-6 rounded-lg"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <button
                ...
                className="w-full py-3 px-4 bg-white text-indigo-600 rounded-lg font-semibold hover:bg-white/90 focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-indigo-500 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
              >
          ...
          >
            <p className="text-white/80">
              ...
              <Link to="/register" className="text-white font-semibold hover:text-white/90 transition-colors duration-200">
                Sign up
              </Link>
            </p>
          </motion.div>
